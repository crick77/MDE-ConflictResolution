...
public class MemberItemProvider extends ModelElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGuardianPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Guardian feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGuardianPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Member_guardian_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Member_guardian_feature", "_UI_Member_type"),
				 FamiliesPackage.Literals.MEMBER__GUARDIAN,
				 true,
				 false,
				 true,
				 null,
