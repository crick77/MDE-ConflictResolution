...
/**
 * This is the item provider adapter for a {@link Families.uncertainty.UData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UDataItemProvider 
	 ...
	 * @generated
	 */
	public UDataItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((UData)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UData_type") :
			getString("_UI_UData_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UData.class)) {
