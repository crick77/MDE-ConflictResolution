...
public class FamiliesFactoryImpl extends EFactoryImpl implements FamiliesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FamiliesPackage.FAMILY_REGISTRY: return createFamilyRegistry();
			default:
	 ...
	 * @generated
	 */
	public FamilyRegistry createFamilyRegistry() {
		FamilyRegistryImpl familyRegistry = new FamilyRegistryImpl();
