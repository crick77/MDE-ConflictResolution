...
public class FamiliesAdapterFactory extends AdapterFactoryImpl {
	...
	protected FamiliesSwitch<Adapter> modelSwitch =
		new FamiliesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFamilyRegistry(FamilyRegistry object) {
				return createFamilyRegistryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Families.FamilyRegistry <em>Family Registry</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFamilyRegistryAdapter() {
		return null;
	}
