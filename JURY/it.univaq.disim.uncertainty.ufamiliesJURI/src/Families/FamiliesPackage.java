...
public interface FamiliesPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int FAMILY__CHILDREN = UncertaintyPackage.MODEL_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int FAMILY__MOTHER = UncertaintyPackage.MODEL_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FAMILY__FATHER = UncertaintyPackage.MODEL_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int FAMILY__ADDRESS = UncertaintyPackage.MODEL_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int FAMILY_FEATURE_COUNT = UncertaintyPackage.MODEL_ELEMENT_FEATURE_COUNT + 5;
	...
	/**
	 * The feature id for the '<em><b>Guardian</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MEMBER__GUARDIAN = UncertaintyPackage.MODEL_ELEMENT_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link Families.Family#getChildren <em>Children</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Children</em>'.
	 * @see Families.Family#getChildren()
	 * @see #getFamily()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link Families.Member#getGuardian <em>Guardian</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Guardian</em>'.
	 * @see Families.Member#getGuardian()
	 * @see #getMember()
	 * @generated
	 */
	EReference getMember_Guardian();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Guardian</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference MEMBER__GUARDIAN = eINSTANCE.getMember_Guardian();
