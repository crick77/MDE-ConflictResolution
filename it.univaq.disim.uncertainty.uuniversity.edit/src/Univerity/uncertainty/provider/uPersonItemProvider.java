...
/**
 * This is the item provider adapter for a {@link Univerity.uncertainty.uPerson} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class uPersonItemProvider extends aPersonItemProvider {
	/**
	 ...
	 * @generated
	 */
	public uPersonItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UncertaintyPackage.Literals.UPERSON__ULEFT);
			childrenFeatures.add(UncertaintyPackage.Literals.UPERSON__URIGHT);
			childrenFeatures.add(UncertaintyPackage.Literals.UPERSON__UPOINT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/uPerson"));
	}
	...
	public String getText(Object object) {
		String label = ((uPerson)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_uPerson_type") :
			getString("_UI_uPerson_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(uPerson.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UncertaintyPackage.Literals.UPERSON__ULEFT,
				 UniverityFactory.eINSTANCE.createPerson()));

		newChildDescriptors.add
			(createChildParameter
				(UncertaintyPackage.Literals.UPERSON__URIGHT,
				 UniverityFactory.eINSTANCE.createPerson()));

		newChildDescriptors.add
			(createChildParameter
				(UncertaintyPackage.Literals.UPERSON__UPOINT,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == UncertaintyPackage.Literals.UPERSON__ULEFT ||
			childFeature == UncertaintyPackage.Literals.UPERSON__URIGHT;
