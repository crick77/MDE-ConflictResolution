...
/**
 * This is the item provider adapter for a {@link Families.uncertainty.uMember} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class uMemberItemProvider extends aMemberItemProvider {
	/**
	 ...
	 * @generated
	 */
	public uMemberItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UncertaintyPackage.Literals.UMEMBER__ULEFT);
			childrenFeatures.add(UncertaintyPackage.Literals.UMEMBER__URIGHT);
			childrenFeatures.add(UncertaintyPackage.Literals.UMEMBER__UPOINT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/uMember"));
	}
	...
	public String getText(Object object) {
		String label = ((uMember)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_uMember_type") :
			getString("_UI_uMember_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(uMember.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UncertaintyPackage.Literals.UMEMBER__ULEFT,
				 FamiliesFactory.eINSTANCE.createMember()));

		newChildDescriptors.add
			(createChildParameter
				(UncertaintyPackage.Literals.UMEMBER__URIGHT,
				 FamiliesFactory.eINSTANCE.createMember()));

		newChildDescriptors.add
			(createChildParameter
				(UncertaintyPackage.Literals.UMEMBER__UPOINT,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == UncertaintyPackage.Literals.UMEMBER__ULEFT ||
			childFeature == UncertaintyPackage.Literals.UMEMBER__URIGHT;
