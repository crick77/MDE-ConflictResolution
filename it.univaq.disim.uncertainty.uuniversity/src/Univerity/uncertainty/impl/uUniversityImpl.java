 ...
 * </p>
 * <ul>
 *   <li>{@link Univerity.uncertainty.impl.uUniversityImpl#getName <em>Name</em>}</li>
 *   <li>{@link Univerity.uncertainty.impl.uUniversityImpl#getUtype <em>Utype</em>}</li>
 *   <li>{@link Univerity.uncertainty.impl.uUniversityImpl#getUleft <em>Uleft</em>}</li>
 *   <li>{@link Univerity.uncertainty.impl.uUniversityImpl#getUright <em>Uright</em>}</li>
 *   <li>{@link Univerity.uncertainty.impl.uUniversityImpl#getUpoint <em>Upoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class uUniversityImpl extends aUniversityImpl implements uUniversity {
	 ...
	 * @ordered
	 */
	protected EList<University> uleft;
	 ...
	 * @ordered
	 */
	protected EList<University> uright;
	 ...
	 * @generated
	 */
	public EList<University> getUleft() {
		if (uleft == null) {
			uleft = new EObjectContainmentEList<University>(University.class, this, UncertaintyPackage.UUNIVERSITY__ULEFT);
		}
		return uleft;
	}
	 ...
	 * @generated
	 */
	public EList<University> getUright() {
		if (uright == null) {
			uright = new EObjectContainmentEList<University>(University.class, this, UncertaintyPackage.UUNIVERSITY__URIGHT);
		}
		return uright;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UncertaintyPackage.UUNIVERSITY__ULEFT:
				getUleft().clear();
				getUleft().addAll((Collection<? extends University>)newValue);
				return;
			case UncertaintyPackage.UUNIVERSITY__URIGHT:
				getUright().clear();
				getUright().addAll((Collection<? extends University>)newValue);
				return;
			case UncertaintyPackage.UUNIVERSITY__UPOINT:
				getUpoint().clear();
