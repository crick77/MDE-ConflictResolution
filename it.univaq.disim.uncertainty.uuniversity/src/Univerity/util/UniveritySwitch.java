 ...
 * @generated
 */
public class UniveritySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case UniverityPackage.UNIVERSITY: {
