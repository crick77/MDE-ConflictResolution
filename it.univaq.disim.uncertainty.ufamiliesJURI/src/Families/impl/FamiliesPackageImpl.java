...
public class FamiliesPackageImpl extends EPackageImpl implements FamiliesPackage {
	 ...
	 * @generated
	 */
	public EReference getMember_Guardian() {
	...
	public void createPackageContents() {
		...
		createEReference(memberEClass, MEMBER__GUARDIAN);
	...
	public void initializePackageContents() {
		...
		initEReference(getFamily_Children(), theUncertaintyPackage.getaMember(), null, "children", null, 0, -1, Family.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMember_Guardian(), theUncertaintyPackage.getaFamily(), null, "guardian", null, 0, 1, Member.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
